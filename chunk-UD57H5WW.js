import{a as I,c as H,e as E,n as D}from"./chunk-52JGG3VS.js";import{j as z}from"./chunk-7IN67ZTX.js";import{$ as f,$b as T,Da as s,La as _,Qa as b,Ua as d,Xb as v,Yb as w,_ as u,ab as a,bb as t,cb as n,db as M,ib as O,jb as h,kb as m,rb as P,tb as r,ub as g,vb as x,wb as S,xb as y,yb as k,za as C}from"./chunk-ZNSDKUAS.js";function U(o,l){if(o&1){let e=O();t(0,"button",15),h("click",function(){let p=u(e).$implicit,c=m();return f(c.selectSection(p))}),t(1,"span",16),r(2),n(),t(3,"span",17),r(4),n()()}if(o&2){let e=l.$implicit,i=m();P("active",(i.selectedSection==null?null:i.selectedSection.id)===e.id),s(2),g(e.icon),s(2),g(e.title)}}function B(o,l){o&1&&(t(0,"div",18),r(1," No topics found matching your search. "),n())}function W(o,l){if(o&1&&(t(0,"div",19)(1,"div",20)(2,"h2"),r(3),n(),t(4,"p",21),r(5),n()(),M(6,"div",22),t(7,"div",23)(8,"p",24)(9,"span",3),r(10,"info"),n(),r(11),n()()()),o&2){let e=m();s(3),g(e.selectedSection.title),s(2),g(e.selectedSection.description),s(),a("innerHTML",e.selectedSection.content,C),s(5),x(" Last updated: ",e.selectedSection.lastUpdated," ")}}function F(o,l){o&1&&(t(0,"div",25)(1,"p"),r(2,"Select a topic from the sidebar to get started."),n()())}var A=class o{constructor(l){this.router=l;this.filteredSections=this.helpSections}selectedSection=null;searchTerm="";helpSections=[{id:"getting-started",title:"Getting Started",icon:"rocket_launch",description:"Learn the basics of BodhPrepIAS and how to create your first session",lastUpdated:"December 26, 2025",content:`
      ...
      `},{id:"best-practices",title:"Best Practices",icon:"lightbulb",description:"Tips and tricks for getting the most out of BodhPrepIAS",lastUpdated:"December 26, 2025",content:`
